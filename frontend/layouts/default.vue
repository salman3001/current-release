...
<template>
  <ScrollArea height="100vh" width="100%">
    <q-layout view="lHh lpR lFf">
      ...
      <q-drawer show-if-above elevated v-model="leftDrawerOpen" side="left" overlay behaviour="" :width="250"
        :breakpoint="25000">
      ...
      <q-page-container class="justify-center row">
        <div style="max-width: 1920px;" class="q-px-sm q-px-sm-md q-px-md-lg q-px-lg-xl">
          <slot />
        </div>
