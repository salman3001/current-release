...
<template>
  <ScrollArea height="100vh" width="100%">
    <q-layout view="hHh lpR lFf">
      ...
      <q-drawer show-if-above bordered v-model="leftDrawerOpen" side="left" :width="250" :breakpoint="500"
        :mini="miniState" @mouseover="miniState = false" @mouseout="miniState = true">
        <q-scroll-area class="fit" :horizontal-thumb-style="{ opacity: 0 }">
          <q-list padding>
            <NuxtLink :to="routes.vendor.dashboard" :class="route.path === routes.home ? 'text-primary' : 'text-muted'
        ">
            ...
            <NuxtLink :to="routes.vendor.service_requirements.list" :class="route.path === routes.service_requirement
        ? 'text-primary'
        : 'text-muted'
        ">
              <q-item clickable v-ripple>
            ...
            <NuxtLink :to="routes.vendor.bookings.list" :class="route.path === routes.blogs ? 'text-primary' : 'text-muted'
        ">
              <q-item clickable v-ripple>
                <q-item-section avatar>
            ...
            <NuxtLink :to="routes.vendor.chat" :class="route.path === routes.blogs ? 'text-primary' : 'text-muted'
        ">
              <q-item clickable v-ripple>
                <q-item-section avatar>
                  <q-icon name="mail" />
            ...
            <NuxtLink :to="routes.vendor.account" :class="route.path === routes.blogs ? 'text-primary' : 'text-muted'
        ">
              <q-item clickable v-ripple>
                <q-item-section avatar>
