...
const logout = () => {
  auth.logout(userTypes.VENDER, () => {
    ...
    navigateTo(routes.auth.vendor_login);
  });
};
  ...
  <q-btn round flat class="btn-grey">
    ...
    <q-menu anchor="bottom left" style="border-radius: 10px">
      <q-list dense style="min-width: 180px" class="">
        <q-item clickable v-close-popup :to="routes.vendor.chat">
          <q-item-section avatar><q-icon name="mail" color="primary"></q-icon></q-item-section>
          <q-item-section> Messages </q-item-section>
        </q-item>
        <q-item clickable v-close-popup :to="routes.vendor.account">
