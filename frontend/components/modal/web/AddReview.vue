...
const creatReview = async () => {
    loading.value = true
    try {
        const data = await customFetch<IPageRes<any>>(apiRoutes.create_review(modal.meta.serviceId), {
            method: 'post',
            body: form.value,
        })
    ...
    <q-card style="width: 100%">
        ...
        <q-card-section class="column q-px-md-sm">
            <q-form @submit="creatReview()">
                ...
                <q-input type="textarea" outlined v-model="form.message" label="Message"
