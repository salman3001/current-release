...
const { onRequest, loading, rows } = onTableRequest('/api/product-tags', pagination)
      ...
      <div class="row justify-between q-gutter-y-sm">
        ...
        <div class="row q-gutter-sm">
          ...
          <q-btn color="primary" @click="() => {
            navigateTo(routes.admin.product.tag.create)
          }
            ">+ Add Tag</q-btn>
        </div>
      </div>
              ...
              <q-btn-dropdown size="sm" color="primary" label="Options">
                <q-list dense>
                  <q-item clickable v-close-popup @click="() => {
                    navigateTo(routes.admin.product.tag.show(props.row.id))
                  ...
                  <q-item clickable v-close-popup @click="() => {
                    navigateTo(routes.admin.product.tag.edit(props.row.id))
                  }
                    ">
                    <q-item-section>
                  ...
                  <q-item clickable v-close-popup @click="
                    modal.togel('deleteRecord', {
                      url: '/api/product-tags/' + props.row.id,
                      tableRef,
                      title: 'Delete Tag?',
                    })
                    ">
