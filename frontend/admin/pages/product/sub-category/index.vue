...
const { onRequest, loading, rows } = onTableRequest('api/product-subcategory', pagination)
      ...
      <div class="row justify-between q-gutter-y-sm">
        ...
        <div class="row q-gutter-sm">
          ...
          <q-btn color="primary" @click="() => {
            navigateTo(routes.admin.product.sub_category.create)
          }
              ...
              <q-btn-dropdown size="sm" color="primary" label="Options">
                <q-list dense>
                  <q-item clickable v-close-popup @click="() => {
                    navigateTo(routes.admin.product.sub_category.show(props.row.id))
                  ...
                  <q-item clickable v-close-popup @click="() => {
                    navigateTo(routes.admin.product.sub_category.edit(props.row.id))
                  ...
                  <q-item clickable v-close-popup @click="
                    modal.togel('deleteRecord', {
                      url: '/api/product-subcategory/' + props.row.id,
                      tableRef,
