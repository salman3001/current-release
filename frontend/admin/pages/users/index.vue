...
const { data: countries } = await CountriesApi.index({
  fields: ['name', 'id']
})
...
const { onRequest, loading, rows } = onTableRequest('/api/users', pagination, {
  populate: {
    address: {
      fields: ['country_id'],
      populate: {
      ...
      <div class="row justify-between q-gutter-y-sm">
        ...
        <div class="row q-gutter-sm">
          ...
          <q-btn color="primary" @click="() => {
            navigateTo(routes.admin.user_create)
          }
            ">+ Add User</q-btn>
        </div>
      </div>
              ...
              <q-btn-dropdown size="sm" color="primary" label="Options">
                <q-list dense>
                  <q-item clickable v-close-popup @click="() => {
                    navigateTo(routes.admin.user_show(props.row.id))
                  }">
                    <q-item-section>
                      <q-item-label>
                  ...
                  <q-item clickable v-close-popup @click="() => {
                    navigateTo(routes.admin.user_edit(props.row.id))
                  }
                    ">
                    <q-item-section>
                      <q-item-label>
