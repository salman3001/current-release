...
import { serviceSubCategoryApi } from '@/utils/BaseApiService';

const route = useRoute();

const { data: subcategory } = await serviceSubCategoryApi.show(route.params.id as string, {
  populate: {
    faqs: {
      fields: ['*']
    },
      ...
      <div>
        ...
        <div class="q-py-md">
          <q-img spinner-color="white" :src="subcategory.thumbnail?.url
            ? $config.public.baseApi + subcategory.thumbnail?.url
