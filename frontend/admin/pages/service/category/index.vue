...
const { onRequest, loading, rows } = onTableRequest('/api/service-category', pagination, {
  populate: {
    subCategory: {
      fields: ['name', 'id'],
    },
      ...
      <div class="row justify-between q-gutter-y-sm">
        ...
        <div class="row q-gutter-sm">
          ...
          <q-btn color="primary" @click="() => {
            navigateTo(routes.admin.service.category.create)
              ...
              <q-btn-dropdown size="sm" color="primary" label="Options">
                <q-list dense>
                  <q-item clickable v-close-popup @click="() => {
                    navigateTo(routes.admin.service.category.show(props.row.id))
                  ...
                  <q-item clickable v-close-popup @click="() => {
                    navigateTo(routes.admin.service.category.edit(props.row.id))
                  ...
                  <q-item clickable v-close-popup @click="
                    modal.togel('deleteRecord', {
                      url: '/api/service-category/' + props.row.id,
                      tableRef,
