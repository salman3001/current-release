...
import { interestApi } from '@/utils/BaseApiService';
...
const { onRequest, loading, rows } = onTableRequest('/api/subscriber', pagination, {
  populate: {
    interests: {
      fields: ['name'],
    },
      ...
      <div class="row justify-between q-gutter-y-sm">
        ...
        <div class="row q-gutter-sm">
          ...
          <q-btn color="primary" @click="() => {
            navigateTo(routes.admin.subscribers.create)
          }
              ...
              <q-btn-dropdown size="sm" color="primary" label="Options">
                <q-list dense>
                  <q-item clickable v-close-popup @click="() => {
                    navigateTo(routes.admin.subscribers.edit(props.row.id))
                  }
                    ">
                    <q-item-section>
                      <q-item-label>
                  ...
                  <q-item clickable v-close-popup @click="
                    modal.togel('deleteRecord', {
                      url: '/api/subscriber/' + props.row.id,
                      tableRef,
