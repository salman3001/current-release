      ...
      <div>
        ...
        <div>
          <q-img spinner-color="white" :src="product.logo?.url
            ? $config.public.baseApi + product.logo?.url
      ...
      <div>
        ...
        <div v-if="product?.logo" class="q-pb-lg">
          <div class="colomn q-col-gutter-md">
            ...
            <div>
              <q-img spinner-color="white" :src="$config.public.baseApi + product.logo?.url" :alt="product?.name"
                style="height: 15rem; width: 15rem;border: 1px solid #e6e4d9;border-radius: 1rem;" />
            </div>
          </div>
        </div>
        <div v-if="product?.screenshots" class="q-pb-lg">
          <div class="colomn q-col-gutter-md">
            ...
            <div class="q-gutter-md">
              <q-img spinner-color="white" v-for="(s, i) in product?.screenshots" :key="i" :src="$config
                .public.baseApi + s?.file?.url"
                style="height: 15rem; width: 15rem;border: 1px solid #e6e4d9;border-radius: 1rem;" />
            </div>
          </div>
        </div>
        <div v-if="product?.cover" class="q-pb-lg">
          <div class="colomn q-col-gutter-md">
            ...
            <div>
              <q-img spinner-color="white" :src="$config
                .public.baseApi + product.cover?.url" :alt="product?.name"
        ...
        <div v-if="product?.brocher" class="q-pb-lg">
          <div class="colomn q-col-gutter-md">
            ...
            <div>
              <q-img spinner-color="white" :src="$config
                .public.baseApi + product.brocher?.url" :alt="product?.name"
                style="height: 15rem; width: 15rem;border: 1px solid #e6e4d9;border-radius: 1rem;" />
          ...
          <div class="colomn q-col-gutter-md">
            ...
            <div>
              <video width="320" height="240" controls style="border-radius: 20px;">
                <source :src="$config.public.baseApi + product.video?.file.url" type="video/mp4">
