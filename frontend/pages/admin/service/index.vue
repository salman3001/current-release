...
import { serviceCategoryApi, serviceSubCategoryApi } from '@/utils/BaseApiService';
...
const { onRequest, loading, rows } = onTableRequest('/api/service', pagination, {
  populate: {
    serviceCategory: {
      fields: ['name', 'id'],
    },
      ...
      <div class="row justify-between q-gutter-y-sm">
        ...
        <div class="row q-gutter-sm">
          ...
          <q-btn color="primary" @click="() => {
            navigateTo(routes.admin.service.create)
          }
            ">+ Add Service</q-btn>
        </div>
      </div>
              ...
              <q-btn-dropdown size="sm" color="primary" label="Options">
                <q-list dense>
                  <q-item clickable v-close-popup @click="() => {
                    navigateTo(routes.admin.service.show(props.row.id))
                  ...
                  <q-item clickable v-close-popup @click="() => {
                    navigateTo(routes.admin.service.edit(props.row.id))
