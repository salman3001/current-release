...
const creatRequirement = async () => {
    ...
    try {
        ...
        if (data.success === true) {
            navigateTo(routes.service_requirement)
        }
    } catch (error) {
        console.log(error);
    }
...
<template>
    <div>
        <br>
        <h1 class="text-h5 text-bold">Post a Service Requirement</h1>
        <br>

        <div>
            <q-card style="width: 100%; max-width: 700px;" class="shadow-9">
                <q-card-section class="column q-px-md-md">
                    <q-form class="q-gutter-y-sm" @submit="creatRequirement">
                        ...
                        <q-card flat class="border cursor-pointer" @click="modal = true">
                            <q-card-section>
                                <div class="text-center full-width text-secondary text-h6"
            ...
            <q-card style="width: 100%">
                ...
                <q-card-section class="column q-gutter-md">
                    ...
                    <div class="row q-gutter-sm justify-end q-pt-lg">
                        ...
                        <q-btn color="primary" type="submit" @click="modal = !modal"
