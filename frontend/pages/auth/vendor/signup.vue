    ...
    <div class="col-12 col-md-7 column full-height">
      ...
      <div class="col-11 row justify-center items-center q-pt-md">
        <q-card class="my-card q-pa-0 no-shadow" :class="$q.screen.lt.sm ? 'full-width' : ''"
            ...
            <q-form class="q-gutter-y-sm" @submit.prevent="signup">
              ...
              <div class="row q-col-gutter-md">
                <div class="col-12">
                  ...
                  <q-input outlined v-model="form.businessName" dense placeholder="Eg. Best Service Providers"
                    :rules="[rules.required('Required')]" />
                </div>
              </div>
              <div class="row q-col-gutter-md">
          ...
          <p class="q--sm text-center">Already have an Vendor's account? <NuxtLink :to="routes.auth.vendor_login">Sign
              in
            </NuxtLink>
          </p>
