      ...
      <div class="row justify-between q-gutter-y-sm">
        ...
        <div class="row q-gutter-sm">
          <q-select
            ...
            v-model="filter.where_service_category_id"
            label="Category"
            class="col-auto"
          ...
          <q-select
            ...
            v-model="filter.where_service_subcategory_id"
            label="Subcategory"
            class="col-auto"
            style="min-width: 8rem"
          />
          <q-select
            ...
            emit-value
            map-options
            v-model="filter.field__is_active"
            :options="[
              { label: 'All', value: '' },
              ...
              <q-td :props="props" class="row q-gutter-x-xs items-center">
                ...
                >
                  ...
                  >
                    <img
                      :src="
                      getImageUrl((props.row as IService).thumbnail?.breakpoints?.thumbnail?.url,'/images/dummy-thumb.jpg')
                    "
              ...
              <q-td :props="props">
                <div>
                  <q-badge
                    ...
                    :label="props.value"
                    class="q-pa-sm q-badge-positive"
                  />
                  <q-badge
                    v-if="props.row.is_active == 0"
                    :label="props.value"
                    class="q-pa-sm q-badge-negative"
                  />
                </div>
              </q-td>
            </template>
