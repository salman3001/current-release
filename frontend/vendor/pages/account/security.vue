...
<template>
    ...
    <NavTabs :links="[{
        label: 'Account',
        url: routes.vendor.account
    }, {
        label: 'Settings',
        url: routes.vendor.settings
    }, {
        label: 'Security',
        url: routes.vendor.security
    }]">
        <br>
        <div class="q-gutter-y-lg">
            ...
            <q-form class="q-gutter-y-sm" style="max-width: 300px" @submit="updatePassword">
                <div>
                    ...
                    <q-input dense v-model="form.old_password" outlined type="password"
        ...
        rules.sameAs(form.password, 'Password doesnt match'),
                ...
                <q-btn type="submit" color="primary" style="width: 100%" :disabled="loading"><loading-indicator
                        v-if="loading" />
                    Submit</q-btn>
            </q-form>
        </div>
